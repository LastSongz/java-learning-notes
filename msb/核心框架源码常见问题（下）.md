...
>       	/** 一级缓存，存储完成初始化的对象 */
>   	private final Map<String, Object> singletonObjects = new Concurrent[[HashMap与ConcurrentHashMap]]<>(256);
>
>   	/** 二级缓存，存储提前暴露出来的对象 */
...
> ```
>
> ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/2746/1743160787088/62a91d55acab4de7a31291b238e3f046.png)
>
> **从源码维度的方式回答：**
>
...
>
> ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/2746/1743160787088/e5094c7f9553441a91cf35b390426801.png)
>
